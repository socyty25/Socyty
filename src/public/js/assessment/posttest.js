document.addEventListener("DOMContentLoaded", function () {
    ...
    const choiceContainers = Array.from(
        document.getElementsByClassName("choice-container2")
    );
    ...
    Swal.fire({
        title: 'Welcome to the Post-test Assessment!',
        html: 'This test is to measure your improvement in your cybersecurity knowledge and awareness. There are 20 questions for this test. Good Luck!',
        icon: 'info',
