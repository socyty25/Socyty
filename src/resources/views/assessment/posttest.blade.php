...
<head>
    ...
    <script src="{{ asset('js/assessment/posttest.js') }}" defer></script>
    ...
    <div class="container">
        ...
        <div id="game" class="justify-center flex-column">
            ...
            <div class="buttons">
                ...
                <form id="finish-form" action="{{ route('assessment.posttest.complete') }}" method="POST" style="display: none;">
                    @csrf
