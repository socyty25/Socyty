...
<html lang="en">
  <head>
    ...
    <script src="{{ asset('js/sim-template/googledrive/login.js') }}" defer></script>
  </head>
  <body>
    <div class="login-container">
      ...
      <div class="right-section">
        <div class="input-container">
          ...
          <p id="error-text" class="error-text" style="display: none;">Please enter your email or phone.</p>
        </div>
