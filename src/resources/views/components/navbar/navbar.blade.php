            ...
            <div class="navbarlink">
                <div class="navbarlinkpc">
                    <div class="links">
                        ...
                        <x-navbar.navbar-link href="/resources" :active="request()->is('sources')"><i class="fas fa-folder-open"></i>   Resources</x-navbar.navbar-link>
                    ...
                    <div class="dropdowncontainer">
                        ...
                        <div x-show="isOpen"
                            ...
                            <form action="{{ route('logout') }}" method="POST">
                                @csrf
                                <button type="submit" role="menuitem" class="dropdownmenu" tabindex="-1">Logout</button>
                            </form>
                        </div>
                    </div>
                    @else
                    <x-navbar.navbar-link href="/loginregis" style="font-weight: bold; font-size: 1em;">Login</x-navbar.navbar-link>
                    @endauth
                </div>
            </div>
    ...
    <div style="background: linear-gradient(rgb(220, 219, 219), rgb(200, 200, 200)) text-black-800">
        <div x-show="isOpen" class="md:hidden" id="mobile-menu">
            <div class="dropmobilemenu">
                ...
                <x-navbar.navbar-link href="/resources" :active="request()->is('sources')">Resources</x-navbar.navbar-link>
            ...
            <div class="mobilemenu2">
                ...
                <div class="mobilemenu3">
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="logoutbutton" role="menuitem" tabindex="-1">Logout</button>
                    </form>
                </div>
                @else
